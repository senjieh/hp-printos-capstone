...
& $python3 aws-iot-device-sdk-python-v2\samples\pubsub.py --endpoint az1v6dihq87k4-ats.iot.us-east-2.amazonaws.com --ca_file root-CA.crt --cert hp_printOS_capstone.cert.pem --key hp_printOS_capstone.private.key --client_id basicPubSub --topic sdk/test/python --count 0