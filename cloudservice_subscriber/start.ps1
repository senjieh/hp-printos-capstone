...
& $python3 aws-iot-device-sdk-python-v2\samples\pubsub.py --endpoint az1v6dihq87k4-ats.iot.us-east-2.amazonaws.com --ca_file root-CA.crt --cert printOS_subscriber.cert.pem --key printOS_subscriber.private.key --client_id basicPubSub --topic sdk/test/python --count 0